...
constexpr uint32_t THINFILM_MAXLAYERS = 8;
...
{
  assert(layers <= THINFILM_MAXLAYERS);
  complex a_cosTheta[THINFILM_MAXLAYERS + 1];
  complex a_phaseDiff[THINFILM_MAXLAYERS - 1];
