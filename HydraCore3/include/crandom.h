...
using LiteMath::uint, LiteMath::uint2, LiteMath::clamp, LiteMath::lerp, LiteMath::int4, LiteMath::min, LiteMath::max, LiteMath::float2, LiteMath::float3, LiteMath::float4, LiteMath::make_float4, LiteMath::make_float2;
#endif
