...
/////////////////////////////////////////////////////////////////////////////////////////// UBO
class MultiRenderer_slang_comp : public MultiRenderer
{
public:

  MultiRenderer_slang_comp(uint32_t AS_type, uint32_t maxPrimitives) : MultiRenderer(AS_type, maxPrimitives)
  {
    if(m_pAccelStruct == nullptr)
      m_pAccelStruct = std::make_shared<BVHRT>();
  }
  const char* Name() const override { return "MultiRenderer_slang_comp";}
  ...
  virtual ~MultiRenderer_slang_comp();
...
protected:
  ...
  MultiRenderer_slang_comp_UBO_Data m_uboData;
