...
void MultiRenderer_slang_comp_rq::AllocateAllDescriptorSets()
{
  // allocate pool
  //
  ...
  buffersSize.descriptorCount = 331 + 64 ; //
  ...
  std::vector<VkDescriptorPoolSize> poolSizes = {buffersSize};
  {
    ...
    accelStorageSize.descriptorCount     = 5;
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateResolveDebugDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateFillGbufferDSLayout()
{
  ...
  // binding for m_pAccelStruct_remap
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateFillGbufferWithTransparencyDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 50+1> dsBindings;
  ...
  // binding for m_pAccelStruct
  dsBindings[4].binding            = 4;
  dsBindings[4].descriptorType     = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
  dsBindings[4].descriptorCount    = 1;
  dsBindings[4].stageFlags         = stageFlags;
  dsBindings[4].pImmutableSamplers = nullptr;
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateResolveOutlineDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateAverageColorDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateTonemapDSLayout()
{
  std::array<VkDescriptorSetLayoutBinding, 2+1> dsBindings;
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreatePackXYDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateResolveCommonDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateResolveCommonWithTransparencyDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreateResolveCTFDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreatecopyKernelFloatDSLayout()
{
...
VkDescriptorSetLayout MultiRenderer_slang_comp_rq::CreatematMulTransposeDSLayout()
{
...
void MultiRenderer_slang_comp_rq::UpdateAllGeneratedDescriptorSets_RenderFloat()
{
  // now create actual bindings
  //
  // descriptor set #0: FillGbufferWithTransparencyCmd (["m_gBuffer","m_matIdOffsets","m_matIdbyPrimId","m_materials","m_pAccelStruct","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_RotAddTable","m_pAccelStruct_m_SCom2Data","m_pAccelStruct_m_SCom2Headers","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfCompactOctreeRotTransforms","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_SdfDAGChildEdges","m_pAccelStruct_m_SdfDAGDataEdges","m_pAccelStruct_m_SdfDAGDistances","m_pAccelStruct_m_SdfDAGHeaders","m_pAccelStruct_m_SdfDAGNodes","m_pAccelStruct_m_SdfDAGTranspositions","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfMultiOctreeNodes","m_pAccelStruct_m_SdfMultiOctreeValues","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfSBSRoots","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_geomData","m_pAccelStruct_m_geomTags","m_pAccelStruct_m_indices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_vertPos","m_pAccelStruct_remap","m_pAccelStruct_startEnd","m_packedXY","m_transparencyBuffer"])
  {
    constexpr uint additionalSize = 1;

    std::array<VkDescriptorBufferInfo, 50 + additionalSize> descriptorBufferInfo;
    std::array<VkDescriptorImageInfo,  50 + additionalSize> descriptorImageInfo;
    std::array<VkAccelerationStructureKHR,  50 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  50 + additionalSize> descriptorAccelInfo;
    std::array<VkWriteDescriptorSet,   50 + additionalSize> writeDescriptorSet;
...

    {
      ...
      if(pScene == nullptr)
        std::cout << "[MultiRenderer_slang_comp_rq::InitAllGeneratedDescriptorSets_RenderFloat]: fatal error, wrong accel struct type" << std::endl;
    ...
    descriptorBufferInfo[5].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersBuffer;
    descriptorBufferInfo[5].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersOffset;
    ...
    descriptorBufferInfo[6].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsBuffer;
    descriptorBufferInfo[6].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsOffset;
    ...
    descriptorBufferInfo[7].buffer = m_vdata.m_pAccelStruct_m_RotAddTableBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_pAccelStruct_m_RotAddTableOffset;
    ...
    descriptorBufferInfo[8].buffer = m_vdata.m_pAccelStruct_m_SCom2DataBuffer;
    descriptorBufferInfo[8].offset = m_vdata.m_pAccelStruct_m_SCom2DataOffset;
    ...
    descriptorBufferInfo[9].buffer = m_vdata.m_pAccelStruct_m_SCom2HeadersBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_pAccelStruct_m_SCom2HeadersOffset;
    ...
    descriptorBufferInfo[10].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotModifiersBuffer;
    descriptorBufferInfo[10].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotModifiersOffset;
    ...
    descriptorBufferInfo[11].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotTransformsBuffer;
    descriptorBufferInfo[11].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotTransformsOffset;
    ...
    descriptorBufferInfo[12].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV3DataBuffer;
    descriptorBufferInfo[12].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV3DataOffset;
    ...
    descriptorBufferInfo[13].buffer = m_vdata.m_pAccelStruct_m_SdfDAGChildEdgesBuffer;
    descriptorBufferInfo[13].offset = m_vdata.m_pAccelStruct_m_SdfDAGChildEdgesOffset;
    ...
    descriptorBufferInfo[14].buffer = m_vdata.m_pAccelStruct_m_SdfDAGDataEdgesBuffer;
    descriptorBufferInfo[14].offset = m_vdata.m_pAccelStruct_m_SdfDAGDataEdgesOffset;
    ...
    descriptorBufferInfo[15].buffer = m_vdata.m_pAccelStruct_m_SdfDAGDistancesBuffer;
    descriptorBufferInfo[15].offset = m_vdata.m_pAccelStruct_m_SdfDAGDistancesOffset;
    ...
    descriptorBufferInfo[16].buffer = m_vdata.m_pAccelStruct_m_SdfDAGHeadersBuffer;
    descriptorBufferInfo[16].offset = m_vdata.m_pAccelStruct_m_SdfDAGHeadersOffset;
    ...
    descriptorBufferInfo[17].buffer = m_vdata.m_pAccelStruct_m_SdfDAGNodesBuffer;
    descriptorBufferInfo[17].offset = m_vdata.m_pAccelStruct_m_SdfDAGNodesOffset;
    ...
    descriptorBufferInfo[18].buffer = m_vdata.m_pAccelStruct_m_SdfDAGTranspositionsBuffer;
    descriptorBufferInfo[18].offset = m_vdata.m_pAccelStruct_m_SdfDAGTranspositionsOffset;
    ...
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeNodesOffset;
    ...
    descriptorBufferInfo[20].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsBuffer;
    descriptorBufferInfo[20].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsOffset;
    ...
    descriptorBufferInfo[21].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesBuffer;
    descriptorBufferInfo[21].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesOffset;
    ...
    descriptorBufferInfo[22].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsBuffer;
    descriptorBufferInfo[22].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsOffset;
    ...
    descriptorBufferInfo[23].buffer = m_vdata.m_pAccelStruct_m_SdfGridDataBuffer;
    descriptorBufferInfo[23].offset = m_vdata.m_pAccelStruct_m_SdfGridDataOffset;
    ...
    descriptorBufferInfo[24].buffer = m_vdata.m_pAccelStruct_m_SdfGridOffsetsBuffer;
    descriptorBufferInfo[24].offset = m_vdata.m_pAccelStruct_m_SdfGridOffsetsOffset;
    ...
    descriptorBufferInfo[25].buffer = m_vdata.m_pAccelStruct_m_SdfGridSizesBuffer;
    descriptorBufferInfo[25].offset = m_vdata.m_pAccelStruct_m_SdfGridSizesOffset;
    ...
    descriptorBufferInfo[26].buffer = m_vdata.m_pAccelStruct_m_SdfMultiOctreeNodesBuffer;
    descriptorBufferInfo[26].offset = m_vdata.m_pAccelStruct_m_SdfMultiOctreeNodesOffset;
    ...
    descriptorBufferInfo[27].buffer = m_vdata.m_pAccelStruct_m_SdfMultiOctreeValuesBuffer;
    descriptorBufferInfo[27].offset = m_vdata.m_pAccelStruct_m_SdfMultiOctreeValuesOffset;
    ...
    descriptorBufferInfo[28].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataBuffer;
    descriptorBufferInfo[28].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataOffset;
    ...
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
    ...
    descriptorBufferInfo[32].buffer = m_vdata.m_pAccelStruct_m_SdfSBSRootsBuffer;
    descriptorBufferInfo[32].offset = m_vdata.m_pAccelStruct_m_SdfSBSRootsOffset;
    ...
    descriptorBufferInfo[34].buffer = m_vdata.m_pAccelStruct_m_SdfSVSRootsBuffer;
    descriptorBufferInfo[34].offset = m_vdata.m_pAccelStruct_m_SdfSVSRootsOffset;
    ...
    descriptorBufferInfo[35].buffer = m_vdata.m_pAccelStruct_m_allNodePairsBuffer;
    descriptorBufferInfo[35].offset = m_vdata.m_pAccelStruct_m_allNodePairsOffset;
    ...
    descriptorBufferInfo[37].buffer = m_vdata.m_pAccelStruct_m_geomTagsBuffer;
    descriptorBufferInfo[37].offset = m_vdata.m_pAccelStruct_m_geomTagsOffset;
    ...
    descriptorBufferInfo[38].buffer = m_vdata.m_pAccelStruct_m_indicesBuffer;
    descriptorBufferInfo[38].offset = m_vdata.m_pAccelStruct_m_indicesOffset;
    ...
    descriptorBufferInfo[39].buffer = m_vdata.m_pAccelStruct_m_instanceDataBuffer;
    descriptorBufferInfo[39].offset = m_vdata.m_pAccelStruct_m_instanceDataOffset;
    ...
    descriptorBufferInfo[40].buffer = m_vdata.m_pAccelStruct_m_nodesTLASBuffer;
    descriptorBufferInfo[40].offset = m_vdata.m_pAccelStruct_m_nodesTLASOffset;
    ...
    descriptorBufferInfo[41].buffer = m_vdata.m_pAccelStruct_m_origNodesBuffer;
    descriptorBufferInfo[41].offset = m_vdata.m_pAccelStruct_m_origNodesOffset;
    ...
    descriptorBufferInfo[42].buffer = m_vdata.m_pAccelStruct_m_primIdCountBuffer;
    descriptorBufferInfo[42].offset = m_vdata.m_pAccelStruct_m_primIdCountOffset;
    ...
    descriptorBufferInfo[43].buffer = m_vdata.m_pAccelStruct_m_primIndicesBuffer;
    descriptorBufferInfo[43].offset = m_vdata.m_pAccelStruct_m_primIndicesOffset;
    ...
    descriptorBufferInfo[44].buffer = m_vdata.m_pAccelStruct_m_vertNormBuffer;
    descriptorBufferInfo[44].offset = m_vdata.m_pAccelStruct_m_vertNormOffset;
    ...
    descriptorBufferInfo[46].buffer = m_vdata.m_pAccelStruct_remapBuffer;
    descriptorBufferInfo[46].offset = m_vdata.m_pAccelStruct_remapOffset;
    ...
    descriptorBufferInfo[47].buffer = m_vdata.m_pAccelStruct_startEndBuffer;
    descriptorBufferInfo[47].offset = m_vdata.m_pAccelStruct_startEndOffset;
    ...
    descriptorBufferInfo[48].buffer = m_vdata.m_packedXYBuffer;
    descriptorBufferInfo[48].offset = m_vdata.m_packedXYOffset;
    ...
    descriptorBufferInfo[49].buffer = m_vdata.m_transparencyBufferBuffer;
    descriptorBufferInfo[49].offset = m_vdata.m_transparencyBufferOffset;
    ...
    writeDescriptorSet[49].dstSet           = m_allGeneratedDS[0];
    ...
    descriptorBufferInfo[50].buffer = m_classDataBuffer;
    descriptorBufferInfo[50].offset = 0;
    ...
    writeDescriptorSet[50].dstSet           = m_allGeneratedDS[0];
  ...
  // descriptor set #2: FillGbufferCmd (["m_gBuffer","m_pAccelStruct","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_RotAddTable","m_pAccelStruct_m_SCom2Data","m_pAccelStruct_m_SCom2Headers","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfCompactOctreeRotTransforms","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_SdfDAGChildEdges","m_pAccelStruct_m_SdfDAGDataEdges","m_pAccelStruct_m_SdfDAGDistances","m_pAccelStruct_m_SdfDAGHeaders","m_pAccelStruct_m_SdfDAGNodes","m_pAccelStruct_m_SdfDAGTranspositions","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfMultiOctreeNodes","m_pAccelStruct_m_SdfMultiOctreeValues","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfSBSRoots","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_geomData","m_pAccelStruct_m_geomTags","m_pAccelStruct_m_indices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_vertPos","m_pAccelStruct_remap","m_pAccelStruct_startEnd","m_packedXY"])
  {
    constexpr uint additionalSize = 1;
    ...
    std::array<VkAccelerationStructureKHR,  46 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  46 + additionalSize> descriptorAccelInfo;
    ...
    descriptorBufferInfo[2]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[2].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersBuffer;
    descriptorBufferInfo[2].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimHeadersOffset;
    descriptorBufferInfo[2].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[2]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[2].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[3]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[3].buffer = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsBuffer;
    descriptorBufferInfo[3].offset = m_vdata.m_pAccelStruct_m_GraphicsPrimPointsOffset;
    descriptorBufferInfo[3].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[3]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[3].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[4]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[4].buffer = m_vdata.m_pAccelStruct_m_RotAddTableBuffer;
    descriptorBufferInfo[4].offset = m_vdata.m_pAccelStruct_m_RotAddTableOffset;
    descriptorBufferInfo[4].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[4]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[4].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[5]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[5].buffer = m_vdata.m_pAccelStruct_m_SCom2DataBuffer;
    descriptorBufferInfo[5].offset = m_vdata.m_pAccelStruct_m_SCom2DataOffset;
    descriptorBufferInfo[5].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[5]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[5].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[6]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[6].buffer = m_vdata.m_pAccelStruct_m_SCom2HeadersBuffer;
    descriptorBufferInfo[6].offset = m_vdata.m_pAccelStruct_m_SCom2HeadersOffset;
    descriptorBufferInfo[6].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[6]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[6].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[7]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[7].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotModifiersBuffer;
    descriptorBufferInfo[7].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotModifiersOffset;
    descriptorBufferInfo[7].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[7]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[7].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[8]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[8].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotTransformsBuffer;
    descriptorBufferInfo[8].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeRotTransformsOffset;
    descriptorBufferInfo[8].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[8]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[8].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[9]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[9].buffer = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV3DataBuffer;
    descriptorBufferInfo[9].offset = m_vdata.m_pAccelStruct_m_SdfCompactOctreeV3DataOffset;
    descriptorBufferInfo[9].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[9]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[9].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[10]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[10].buffer = m_vdata.m_pAccelStruct_m_SdfDAGChildEdgesBuffer;
    descriptorBufferInfo[10].offset = m_vdata.m_pAccelStruct_m_SdfDAGChildEdgesOffset;
    descriptorBufferInfo[10].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[10]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[10].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[11]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[11].buffer = m_vdata.m_pAccelStruct_m_SdfDAGDataEdgesBuffer;
    descriptorBufferInfo[11].offset = m_vdata.m_pAccelStruct_m_SdfDAGDataEdgesOffset;
    descriptorBufferInfo[11].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[11]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[11].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[12]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[12].buffer = m_vdata.m_pAccelStruct_m_SdfDAGDistancesBuffer;
    descriptorBufferInfo[12].offset = m_vdata.m_pAccelStruct_m_SdfDAGDistancesOffset;
    descriptorBufferInfo[12].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[12]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[12].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[13]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[13].buffer = m_vdata.m_pAccelStruct_m_SdfDAGHeadersBuffer;
    descriptorBufferInfo[13].offset = m_vdata.m_pAccelStruct_m_SdfDAGHeadersOffset;
    descriptorBufferInfo[13].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[13]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[13].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[14]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[14].buffer = m_vdata.m_pAccelStruct_m_SdfDAGNodesBuffer;
    descriptorBufferInfo[14].offset = m_vdata.m_pAccelStruct_m_SdfDAGNodesOffset;
    descriptorBufferInfo[14].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[14]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[14].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[15]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[15].buffer = m_vdata.m_pAccelStruct_m_SdfDAGTranspositionsBuffer;
    descriptorBufferInfo[15].offset = m_vdata.m_pAccelStruct_m_SdfDAGTranspositionsOffset;
    descriptorBufferInfo[15].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[15]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[15].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[17]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[17].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsBuffer;
    descriptorBufferInfo[17].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeRootsOffset;
    descriptorBufferInfo[17].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[17]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[17].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[18]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[18].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesBuffer;
    descriptorBufferInfo[18].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexNodesOffset;
    descriptorBufferInfo[18].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[18]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[18].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[19]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[19].buffer = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsBuffer;
    descriptorBufferInfo[19].offset = m_vdata.m_pAccelStruct_m_SdfFrameOctreeTexRootsOffset;
    descriptorBufferInfo[19].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[19]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[19].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[20]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[20].buffer = m_vdata.m_pAccelStruct_m_SdfGridDataBuffer;
    descriptorBufferInfo[20].offset = m_vdata.m_pAccelStruct_m_SdfGridDataOffset;
    descriptorBufferInfo[20].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[20]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[20].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[23]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[23].buffer = m_vdata.m_pAccelStruct_m_SdfMultiOctreeNodesBuffer;
    descriptorBufferInfo[23].offset = m_vdata.m_pAccelStruct_m_SdfMultiOctreeNodesOffset;
    descriptorBufferInfo[23].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[23]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[23].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[24]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[24].buffer = m_vdata.m_pAccelStruct_m_SdfMultiOctreeValuesBuffer;
    descriptorBufferInfo[24].offset = m_vdata.m_pAccelStruct_m_SdfMultiOctreeValuesOffset;
    descriptorBufferInfo[24].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[24]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[24].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[25]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[25].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataBuffer;
    descriptorBufferInfo[25].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataOffset;
    descriptorBufferInfo[25].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[25]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[25].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[26]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[26].buffer = m_vdata.m_pAccelStruct_m_SdfSBSDataFBuffer;
    descriptorBufferInfo[26].offset = m_vdata.m_pAccelStruct_m_SdfSBSDataFOffset;
    descriptorBufferInfo[26].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[26]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[26].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[28]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[28].buffer = m_vdata.m_pAccelStruct_m_SdfSBSNodesBuffer;
    descriptorBufferInfo[28].offset = m_vdata.m_pAccelStruct_m_SdfSBSNodesOffset;
    descriptorBufferInfo[28].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[28]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[28].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[29]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[29].buffer = m_vdata.m_pAccelStruct_m_SdfSBSRootsBuffer;
    descriptorBufferInfo[29].offset = m_vdata.m_pAccelStruct_m_SdfSBSRootsOffset;
    descriptorBufferInfo[29].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[29]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[29].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[30]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[30].buffer = m_vdata.m_pAccelStruct_m_SdfSVSNodesBuffer;
    descriptorBufferInfo[30].offset = m_vdata.m_pAccelStruct_m_SdfSVSNodesOffset;
    descriptorBufferInfo[30].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[30]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[30].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[31]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[31].buffer = m_vdata.m_pAccelStruct_m_SdfSVSRootsBuffer;
    descriptorBufferInfo[31].offset = m_vdata.m_pAccelStruct_m_SdfSVSRootsOffset;
    descriptorBufferInfo[31].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[31]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[31].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[32]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[32].buffer = m_vdata.m_pAccelStruct_m_allNodePairsBuffer;
    descriptorBufferInfo[32].offset = m_vdata.m_pAccelStruct_m_allNodePairsOffset;
    descriptorBufferInfo[32].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[32]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[32].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[33]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[33].buffer = m_vdata.m_pAccelStruct_m_geomDataBuffer;
    descriptorBufferInfo[33].offset = m_vdata.m_pAccelStruct_m_geomDataOffset;
    descriptorBufferInfo[33].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[33]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[33].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[34]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[34].buffer = m_vdata.m_pAccelStruct_m_geomTagsBuffer;
    descriptorBufferInfo[34].offset = m_vdata.m_pAccelStruct_m_geomTagsOffset;
    descriptorBufferInfo[34].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[34]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[34].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[36]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[36].buffer = m_vdata.m_pAccelStruct_m_instanceDataBuffer;
    descriptorBufferInfo[36].offset = m_vdata.m_pAccelStruct_m_instanceDataOffset;
    descriptorBufferInfo[36].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[36]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[36].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[37]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[37].buffer = m_vdata.m_pAccelStruct_m_nodesTLASBuffer;
    descriptorBufferInfo[37].offset = m_vdata.m_pAccelStruct_m_nodesTLASOffset;
    descriptorBufferInfo[37].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[37]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[37].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[39]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[39].buffer = m_vdata.m_pAccelStruct_m_primIdCountBuffer;
    descriptorBufferInfo[39].offset = m_vdata.m_pAccelStruct_m_primIdCountOffset;
    descriptorBufferInfo[39].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[39]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[39].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[40]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[40].buffer = m_vdata.m_pAccelStruct_m_primIndicesBuffer;
    descriptorBufferInfo[40].offset = m_vdata.m_pAccelStruct_m_primIndicesOffset;
    descriptorBufferInfo[40].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[40]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[40].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[41]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[41].buffer = m_vdata.m_pAccelStruct_m_vertNormBuffer;
    descriptorBufferInfo[41].offset = m_vdata.m_pAccelStruct_m_vertNormOffset;
    descriptorBufferInfo[41].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[41]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[41].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[42]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[42].buffer = m_vdata.m_pAccelStruct_m_vertPosBuffer;
    descriptorBufferInfo[42].offset = m_vdata.m_pAccelStruct_m_vertPosOffset;
    descriptorBufferInfo[42].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[42]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[42].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[43]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[43].buffer = m_vdata.m_pAccelStruct_remapBuffer;
    descriptorBufferInfo[43].offset = m_vdata.m_pAccelStruct_remapOffset;
    descriptorBufferInfo[43].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[43]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[43].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[44]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[44].buffer = m_vdata.m_pAccelStruct_startEndBuffer;
    descriptorBufferInfo[44].offset = m_vdata.m_pAccelStruct_startEndOffset;
    descriptorBufferInfo[44].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[44]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[44].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    ...
    descriptorBufferInfo[45]        = VkDescriptorBufferInfo{};
    descriptorBufferInfo[45].buffer = m_vdata.m_packedXYBuffer;
    descriptorBufferInfo[45].offset = m_vdata.m_packedXYOffset;
    descriptorBufferInfo[45].range  = VK_WHOLE_SIZE;
    writeDescriptorSet[45]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[45].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
  ...
  // descriptor set #3: ResolveCommonCmd (["m_colorBuffer.data()","m_gBuffer","m_geomOffsets","m_indices","m_instanceTransformInvTransposed","m_lights","m_matIdOffsets","m_matIdbyPrimId","m_materials","m_normals","m_textures","m_vertices"])
  {
    ...
    std::array<VkAccelerationStructureKHR,  12 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  12 + additionalSize> descriptorAccelInfo;
  ...
  // descriptor set #6: ResolveOutlineCmd (["m_colorBuffer.data()","m_gBuffer","m_geomOffsets","m_indices","m_instanceTransformInvTransposed","m_lights","m_normals","m_vertices"])
  {
    ...
    std::array<VkAccelerationStructureKHR,  8 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  8 + additionalSize> descriptorAccelInfo;
...
void MultiRenderer_slang_comp_rq::UpdateAllGeneratedDescriptorSets_Render()
{
  // now create actual bindings
  //
  // descriptor set #9: FillGbufferWithTransparencyCmd (["m_gBuffer","m_matIdOffsets","m_matIdbyPrimId","m_materials","m_pAccelStruct","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_RotAddTable","m_pAccelStruct_m_SCom2Data","m_pAccelStruct_m_SCom2Headers","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfCompactOctreeRotTransforms","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_SdfDAGChildEdges","m_pAccelStruct_m_SdfDAGDataEdges","m_pAccelStruct_m_SdfDAGDistances","m_pAccelStruct_m_SdfDAGHeaders","m_pAccelStruct_m_SdfDAGNodes","m_pAccelStruct_m_SdfDAGTranspositions","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfMultiOctreeNodes","m_pAccelStruct_m_SdfMultiOctreeValues","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfSBSRoots","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_geomData","m_pAccelStruct_m_geomTags","m_pAccelStruct_m_indices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_vertPos","m_pAccelStruct_remap","m_pAccelStruct_startEnd","m_packedXY","m_transparencyBuffer"])
  {
    constexpr uint additionalSize = 1;
...

    {
      VulkanRTX* pScene = dynamic_cast<VulkanRTX*>(m_pAccelStruct->UnderlyingImpl(1));
      if(pScene == nullptr)
        std::cout << "[MultiRenderer_slang_comp_rq::InitAllGeneratedDescriptorSets_Render]: fatal error, wrong accel struct type" << std::endl;
      accelStructs       [4] = pScene->GetSceneAccelStruct();
      descriptorAccelInfo[4] = {VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR,VK_NULL_HANDLE,1,&accelStructs[4]};
    }
    writeDescriptorSet[4]                  = VkWriteDescriptorSet{};
    ...
    writeDescriptorSet[49]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[49].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[49].dstSet           = m_allGeneratedDS[9];
    writeDescriptorSet[49].dstBinding       = 49;
    writeDescriptorSet[49].descriptorCount  = 1;
    writeDescriptorSet[49].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[49].pBufferInfo      = &descriptorBufferInfo[49];
    ...
    writeDescriptorSet[50]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[50].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[50].dstSet           = m_allGeneratedDS[9];
    writeDescriptorSet[50].dstBinding       = 50;
    writeDescriptorSet[50].descriptorCount  = 1;
    writeDescriptorSet[50].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER ;
    writeDescriptorSet[50].pBufferInfo      = &descriptorBufferInfo[50];
  ...
  // descriptor set #11: FillGbufferCmd (["m_gBuffer","m_pAccelStruct","m_pAccelStruct_m_GraphicsPrimHeaders","m_pAccelStruct_m_GraphicsPrimPoints","m_pAccelStruct_m_RotAddTable","m_pAccelStruct_m_SCom2Data","m_pAccelStruct_m_SCom2Headers","m_pAccelStruct_m_SdfCompactOctreeRotModifiers","m_pAccelStruct_m_SdfCompactOctreeRotTransforms","m_pAccelStruct_m_SdfCompactOctreeV3Data","m_pAccelStruct_m_SdfDAGChildEdges","m_pAccelStruct_m_SdfDAGDataEdges","m_pAccelStruct_m_SdfDAGDistances","m_pAccelStruct_m_SdfDAGHeaders","m_pAccelStruct_m_SdfDAGNodes","m_pAccelStruct_m_SdfDAGTranspositions","m_pAccelStruct_m_SdfFrameOctreeNodes","m_pAccelStruct_m_SdfFrameOctreeRoots","m_pAccelStruct_m_SdfFrameOctreeTexNodes","m_pAccelStruct_m_SdfFrameOctreeTexRoots","m_pAccelStruct_m_SdfGridData","m_pAccelStruct_m_SdfGridOffsets","m_pAccelStruct_m_SdfGridSizes","m_pAccelStruct_m_SdfMultiOctreeNodes","m_pAccelStruct_m_SdfMultiOctreeValues","m_pAccelStruct_m_SdfSBSData","m_pAccelStruct_m_SdfSBSDataF","m_pAccelStruct_m_SdfSBSHeaders","m_pAccelStruct_m_SdfSBSNodes","m_pAccelStruct_m_SdfSBSRoots","m_pAccelStruct_m_SdfSVSNodes","m_pAccelStruct_m_SdfSVSRoots","m_pAccelStruct_m_allNodePairs","m_pAccelStruct_m_geomData","m_pAccelStruct_m_geomTags","m_pAccelStruct_m_indices","m_pAccelStruct_m_instanceData","m_pAccelStruct_m_nodesTLAS","m_pAccelStruct_m_origNodes","m_pAccelStruct_m_primIdCount","m_pAccelStruct_m_primIndices","m_pAccelStruct_m_vertNorm","m_pAccelStruct_m_vertPos","m_pAccelStruct_remap","m_pAccelStruct_startEnd","m_packedXY"])
  {
    constexpr uint additionalSize = 1;
    ...
    writeDescriptorSet[45]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[45].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[45].dstSet           = m_allGeneratedDS[11];
    writeDescriptorSet[45].dstBinding       = 45;
    writeDescriptorSet[45].descriptorCount  = 1;
    writeDescriptorSet[45].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    writeDescriptorSet[45].pBufferInfo      = &descriptorBufferInfo[45];
    ...
    writeDescriptorSet[46]                  = VkWriteDescriptorSet{};
    writeDescriptorSet[46].sType            = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
    writeDescriptorSet[46].dstSet           = m_allGeneratedDS[11];
    writeDescriptorSet[46].dstBinding       = 46;
    writeDescriptorSet[46].descriptorCount  = 1;
    writeDescriptorSet[46].descriptorType   = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER ;
    writeDescriptorSet[46].pBufferInfo      = &descriptorBufferInfo[46];
...
void MultiRenderer_slang_comp_rq::UpdateAllGeneratedDescriptorSets_Clear()
{
  // now create actual bindings
  //
