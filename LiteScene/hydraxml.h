...
namespace hydra_xml
{
  ...
  std::variant<float, LiteMath::float3, LiteMath::float4> readvalVariant(const pugi::xml_node &a_node);
  ...
  public:
    ...
    pugi::xml_object_range<pugi::xml_node_iterator> SettingsNodes() { return m_settingsNode.children();   }
    pugi::xml_object_range<pugi::xml_node_iterator> SceneNodes()    { return m_scenesNode.children();   }
    ...
    size_t GetLightInstancesNum() const { return m_numLightInstances; }
