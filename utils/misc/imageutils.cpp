/*
  This file is copied from HydraCore3/
*/
#include "imageutils.h"
// #include "include/cglobals.h" // Need only one function from here
#include "Image2d.h"

#include "tinyexr.h"

/*
  Need only this function from HydraCore3/include/cglobals.h
*/
